        ...
        _svgContainer// mouse event not working on _chartCanvas
            ...
            .on('mousemove', function () {
                ...
                if (mX > 0 && mY > 0 && mX < width) { 
                    ...
                    var nearestDateVal = minDistanceDate(_.map(_graphs, function (d) { console.log(d);
                        return d.map[mX] ? d.map[mX].date : null; }), dt);
