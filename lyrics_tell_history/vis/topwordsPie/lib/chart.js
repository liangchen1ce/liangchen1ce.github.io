(function (){
  ...
  VIZ.bar = function (color, data) {
    ...
    function mouseover(d, i) {
        ...
        console.log(d.spotify_id + "  fff");

        var CLIENT_ID = 'a9ce03d912d54b1c9db19e40aa57a21d';
        var REDIRECT_URI = 'http://liangchen.soy/';
        ...
        $.ajax({
          ...
          headers: {"Authorization":"Basic YTljZTAzZDkxMmQ1NGIxYzlkYjE5ZTQwYWE1N2EyMWQ6NmE0YmQwYTMwMWM3NDRjMDgyMjJiNzFlNTQ1ZmI0NDg="},
        ...
        function followPlaylist(accessToken) {
          $.ajax({
